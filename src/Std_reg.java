 ...
 * @author RAJA MISHRA
 */
public class Std_reg extends javax.swing.JInternalFrame {

    /**
     * Creates new form vehicle_reg
     */
    public Std_reg() {
        initComponents();
    ...
    private void initComponents() {
        ...
        cb1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Science", "Commerce", "Arts", " " }));
        ...
        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/chair.png"))); // NOI18N
        ...
        jLabel9.setText("STUDENT REGISTRATION FORM");
...
char gender;
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        obj.loaddriver();
        obj.conn();
        String qry="insert into student values('"+t1.getText()+"','"+t2.getText()+"','"+gender+"','"+cb1.getSelectedItem()+"','"+dor+"','"+ta.getText()+"','"+t3.getText()+"','"+t4.getText()+"')";
        try{
