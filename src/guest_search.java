 ...
 * @author KAUSHAL
 */
public class guest_search extends javax.swing.JInternalFrame {
 DefaultTableModel model;
    /**
     * Creates new form guest_search
     */
    public guest_search() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jt1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Guest ID", "Name", "Gender", "Address", "Contact_No."
            }
        ) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String qry = null;
        if (cb1.isSelected()) {
            qry = "select guest_id,name,gender,address,contact_no from guest where name='" + t1.getText() + "'";
        } else if (cb2.isSelected()) {
            qry = "select guest_id,name,gender,address,contact_no from guest where guest_id='" + t1.getText() + "'";
        } else {
        ...
        try {
            while (obj.rs.next()) {
                Object o[] = new Object[]{obj.rs.getString(1), obj.rs.getString(2), obj.rs.getString(3), obj.rs.getString(4), obj.rs.getString(5)};
