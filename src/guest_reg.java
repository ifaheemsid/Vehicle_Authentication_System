 ...
 * @author RAJA MISHRA
 */
public class guest_reg extends javax.swing.JInternalFrame {

    /**
     * Creates new form guest_reg
     */
    public guest_reg() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel9.setText("GUEST REGISTRATION FORM");
 ...
 void clear()
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        obj.loaddriver();
        obj.conn();
        String qry="insert into guest values('"+t1.getText()+"','"+t2.getText()+"','"+gender+"','"+ta.getText()+"','"+t3.getText()+"','"+t4.getText()+"')";
        try{
