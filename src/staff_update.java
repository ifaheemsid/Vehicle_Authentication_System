 ...
 * @author RAJA MISHRA
 */
public class staff_update extends javax.swing.JInternalFrame {
dbconn obj;
    /**
    ...
    private void initComponents() {
        ...
        cmb.setBackground(new java.awt.Color(0, 204, 204));
        cmb.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Clerk", "Peon", " Professor", "Vice-Chancellor  " }));
        ...
        jLabel9.setText("STAFF UPDATION FORM");
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 10, 450, -1));
...
char gender;
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String qry="update staff set name='"+t2.getText()+"',gender='"+gender+"',designation='"+cmb.getSelectedItem()+"',address='"+ta.getText()+"',contact_no='"+t3.getText()+"',mail_id='"+t4.getText()+"' where staff_id='"+t1.getText()+"'";
        ...
        try{
            ...
            Logger.getLogger(staff_update.class.getName()).log(Level.SEVERE,null,ex);
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        obj.fetch("select *from staff where staff_id="+t1.getText()+"");
        try {
            if(obj.rs.next())
            {
                t2.setText(obj.rs.getString(2));
                t3.setText(obj.rs.getString(6));
                t4.setText(obj.rs.getString(7));

                ta.setText(obj.rs.getString(5));
                if(obj.rs.getString(3).equals("m"))
                r1.setSelected(true);
                else
                r2.setSelected(true);
                cmb.setSelectedItem(obj.rs.getString(4));
